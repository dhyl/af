...
/* 配送状态 */
define('SS_UNSHIPPED',              0); // 未派车
define('SS_SHIPPED',                1); // 已派车
define('SS_RECEIVED',               2); // 已收货
define('SS_PREPARING',              3); // 备货中
define('SS_SHIPPED_PART',           4); // 已派车(部分商品)
define('SS_SHIPPED_ING',            5); // 派车中(处理分单)
define('OS_SHIPPED_PART',           6); // 已派车(部分商品)
...
/* 综合状态 */
define('CS_AWAIT_PAY',              100); // 待付款：货到付款且已派车且未付款，非货到付款且未付款
define('CS_AWAIT_SHIP',             101); // 待派车：货到付款且未派车，非货到付款且已付款且未派车
define('CS_FINISHED',               102); // 已完成：已确认、已付款、已派车
define('CS_CAR_OUT',              103); //执行中
...
define('GBS_SUCCEED',               3); // 团购成功（可以派车了）
